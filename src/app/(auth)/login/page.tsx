    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-background">
        <div className="w-full max-w-[400px]">
          ...
          {showVerified && <FadeIn><div className="mb-4 rounded-xl bg-emerald-500/10 p-3 text-sm text-emerald-600 flex items-center gap-2"><CheckCircle className="h-4 w-4" />Email verified! You can now sign in.</div></FadeIn>}
