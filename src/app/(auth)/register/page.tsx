...
import { Eye, EyeOff, ArrowRight, Loader2, Mail, CheckCircle } from 'lucide-react'
        ...
        <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
          ...
          <div className="relative z-10 flex flex-col justify-between p-12 w-full">
            <Link href="/" className="inline-flex items-center gap-2">
              <img src="/logo.svg" alt="PostPencil" className="h-12 w-auto brightness-0 invert" />
            </Link>
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-white leading-tight tracking-tight">
                Share knowledge.<br /><span className="text-zinc-400">Learn together.</span>
              </h2>
              <p className="text-zinc-400 text-lg max-w-md leading-relaxed">
                Join thousands of students sharing notes, resources, and study materials in a social learning experience.
              </p>
            ...
            <div className="space-y-3">
              {resendCooldown > 0 ? (
                <p className="text-sm text-muted-foreground">
                  Resend in <span className="font-semibold tabular-nums">{resendCooldown}s</span>
                </p>
              ) : (
                <Button
                  variant="outline"
        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 h-11 rounded-xl border border-border bg-background hover:bg-accent text-sm font-medium transition-all active:scale-[0.98]"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {passwordChecks.map((check) => (
                    <div key={check.label} className="flex items-center gap-1.5 text-xs">
                      <div className={cn(
                        ...
                        check.valid ? "bg-emerald-500" : "bg-muted-foreground/30"
                      )} />
            ...
            <Button
              type="submit"
              className="w-full h-11 rounded-xl font-medium text-sm bg-foreground text-background hover:bg-foreground/90 active:scale-[0.98] transition-all"
              disabled={loading}
            >
              {loading ? (
