...
export const metadata: Metadata = {
  ...
  description:
    'Standards for behavior and content that help PostPencil remain a safe, inclusive, and valuable learning community.',
  alternates: {
    canonical: 'https://postpencil.com/guidelines',
  },
}
